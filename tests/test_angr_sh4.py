...
def test_dynamic(pth):
	...
	c.add_cond(0x400438, Cond('r15', '==', 0x7fff0000 - 4))
	c.add_cond(0x40043a, Cond('r14', '==', lambda c: c.s().regs.r15))
	c.add_cond(0x40043c, Cond('r1', '==', 0x400c38))
	c.add_cond(0x40043e, Cond('r6', '==', 31))
	c.add_cond(0x400440, Cond('r5', '==', lambda c: c.s().regs.r1))
	c.add_cond(0x400442, Cond('r4', '==', 1))
	c.add_cond(0x400444, Cond('r1', '==', 0x04006a4))
	c.add_cond(0x400446, Cond('prevPc', '==', 0x400444))
	c.add_cond(0x400446, Cond('pr', '==', 0x400444+4))
	c.add_cond(0x4006a4, Cond('prevPc', '==', 0x400444+2))
	c.add_cond(0x4006aa, Cond('r15', '==', 0x7fff0000 - 16))
	c.add_cond(0x4006ac, Cond('r15', '==', 0x7fff0000 - 40))
	c.add_cond(0x4006b0, Cond('r14', '==', lambda c: c.s().regs.r15))
	c.add_cond(0x4006b0, Cond('r1', '==', lambda c: c.s().regs.r14))
	c.add_cond(0x4006b2, Cond('r1', '==', lambda c: c.s().regs.r14 - 40))
	c.add_cond(0x4006b4, Cond('r4', '==', lambda c: c.mem(c.reg().r1 + 48)))
	c.add_cond(0x4006b6, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006b8, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006ba, Cond('r5', '==', lambda c: c.mem(c.reg().r1 + 44)))
	c.add_cond(0x4006bc, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006be, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006c0, Cond('r6', '==', lambda c: c.mem(c.reg().r1 + 40)))
	c.add_cond(0x4006c2, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006c4, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006c6, Cond('r2', '==', 0))
	c.add_cond(0x4006c8, Cond('r2', '==', lambda c: c.mem(c.reg().r1 + 60)))
	c.add_cond(0x4006ca, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006cc, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006ce, Cond('r2', '==', 0))
	c.add_cond(0x4006d0, Cond('r2', '==', lambda c: c.mem(c.reg().r1 + 52)))
	c.add_cond(0x4006d2, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006d4, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006d6, Cond('r1', '==', lambda c: c.mem(0x7ffeffb0 + 44)))
	c.add_cond(0x4006d8, Cond('sr', '& 1', 0))
	c.add_cond(0x4006e0, Cond('prevPc', '==', 0x4006d8))
	c.add_cond(0x4006e2, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006e4, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006e6, Cond('r1', '==', lambda c: c.mem(c.reg().r14)))
	c.add_cond(0x4006e8, Cond('sr', '& 1', 0))	
	c.add_cond(0x40075e, Cond('prevPc', '==', 0x4006e8))
	c.add_cond(0x400760, Cond('r2', '==', lambda c: c.reg().r14))
	c.add_cond(0x400762, Cond('r2', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x400764, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x400766, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x400768, Cond('r2', '==', lambda c: c.mem(c.reg().r14 + 20)))
	c.add_cond(0x40076a, Cond('r1', '==', lambda c: c.mem(c.reg().r14)))
	c.add_cond(0x40076c, Cond('sr', '& 1', 0))	
	c.add_cond(0x4006f0, Cond('prevPc', '==', 0x40076c))
	c.add_cond(0x4006f2, Cond('r2', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006f4, Cond('r2', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006f6, Cond('r1', '==', lambda c: c.reg().r14))
	c.add_cond(0x4006f8, Cond('r1', '==', lambda c: c.reg().r14 - 40))
	c.add_cond(0x4006fa, Cond('r2', '==', lambda c: c.mem(c.reg().r14 + 4)))
	c.add_cond(0x4006fc, Cond('r1', '==', lambda c: c.mem(c.reg().r14 + 20)))
	c.add_cond(0x4006fe, Cond('r2', '==', lambda c: c.reg().r3))
	c.add_cond(0x400700, Cond('r3', '==', lambda c: c.reg().r1 + c.reg().r2))
	c.add_cond(0x400700, Cond('r2', '!=', lambda c: c.reg().r14))
	c.add_cond(0x400702, Cond('r2', '==', lambda c: c.reg().r14))
	c.add_cond(0x400704, Cond('r2', '==', lambda c: c.reg().r14 - 40))	
	c.add_cond(0x40070e, Cond('r2', '==', lambda c: c.mem(c.reg().r14) - c.mem(c.reg().r14 + 20)))
	c.add_cond(0x4003fc, Cond('r0', '==', 0x400400))
	c.add_cond(0x400400, Cond('prevPc', '==', 0x4003fe))
	c.add_cond(0x400350, Cond('prevPc', '==', lambda c: c.mem(0x411020)))
